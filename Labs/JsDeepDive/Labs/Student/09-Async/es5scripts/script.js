...
function doIt() {
  ...
  displayMessage('info', "Promise ".concat(thisPromiseCount, ", sync code started")); // TODO: Create a Promise object. Pass a function into the Promise constructor, which does the following:
